...
test("plaseShip values cant be bigger or smaller than the board size", () => {
    gameboard.placeShip([[11, 2]], new Ship(1));
    expect(gameboard.getCell(11, 2)).toBeNull();

    gameboard.placeShip([[0, 12]], new Ship(1));
    expect(gameboard.getCell(0, 12)).toBeNull();

    gameboard.placeShip([[-1, -11]], new Ship(1));
    expect(gameboard.getCell(-1, -11)).toBeNull();

    gameboard.placeShip([[-1, 2]], new Ship(1));
    expect(gameboard.getCell(-1, -2)).toBeNull();

    gameboard.placeShip([[0, -5]], new Ship(1));
    expect(gameboard.getCell(0, -5)).toBeNull();
});
